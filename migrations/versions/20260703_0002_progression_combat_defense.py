...
def upgrade() -> None:
    with op.batch_alter_table("players") as batch_op:
        ...
        batch_op.add_column(
            sa.Column("combat_xp_to_next_level", sa.Integer(), nullable=False, server_default="1140")
        )
        batch_op.add_column(
            sa.Column("unspent_stat_points", sa.Integer(), nullable=False, server_default="0")
        )
        batch_op.add_column(sa.Column("defense_wins", sa.Integer(), nullable=False, server_default="0"))
        batch_op.add_column(
            sa.Column("highest_unlocked_dungeon_level", sa.Integer(), nullable=False, server_default="1")
        )
        batch_op.add_column(
            sa.Column("highest_completed_dungeon_level", sa.Integer(), nullable=False, server_default="1")
        )
        batch_op.add_column(sa.Column("progression_schema_version", sa.Integer(), nullable=False, server_default="2"))
    ...
    op.create_index(
        "ix_players_dungeon_progression",
        "players",
        ["guild_id", "highest_unlocked_dungeon_level"],
    )
    with op.batch_alter_table("exploration_sessions") as batch_op:
        batch_op.add_column(sa.Column("dungeon_level", sa.Integer(), nullable=False, server_default="1"))
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("exploration_sessions") as batch_op:
        batch_op.drop_column("dungeon_level")
    op.drop_index("ix_players_dungeon_progression", table_name="players")
    ...
    with op.batch_alter_table("players") as batch_op:
        ...
        batch_op.drop_column("progression_schema_version")
        batch_op.drop_column("highest_completed_dungeon_level")
        batch_op.drop_column("highest_unlocked_dungeon_level")
        batch_op.drop_column("defense_wins")
